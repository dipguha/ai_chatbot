...
RETURN_POLICIES = {
    ...
    "video": {"window": "2 days", "condition": "Can watch for 2 days", "refund": "Full refund within 2 days, no refund after"},
}
...
PRODUCTS = {
    ...
    "PROD-006": {"name": "Avatar 3", "price": 6.99, "category": "video", "description": "Avatar new movie released 2026", "warranty_months": 1},
}
